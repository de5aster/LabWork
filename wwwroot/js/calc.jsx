...
//                <footer>                   
//                    <p>2018, &#169; Copyright Kalistratov Anton</p>                                       
//                </footer>
//            </div>
//        );
//    }
...
class ContentCalc extends React.Component {
    ...
    onFSubmit = (e) => {
        ...
        fetch(this.props.apiUrlUpload, {
            ...
            if (res.status === 400) {
                this.setErrorMessage("Выписка некорректного формата. Выберите другой файл.");
            }
        }, function () {
                    this.setState({
    ...
    render() {
        ...
        return (
            <div className="content" style={{ marginTop: '50px', padding: "10px 30px" }}>
...
class Restore extends React.Component {
    ...
    onRestoreRequest3 = () => {
        this.restoreDocumentCalculate();
        setTimeout(this.requestOnServer, 50);
                                    ...
                                    <form onSubmit={this.onRestoreRequest2}>
                                        ...
                                        <div className="kkm">    
                                            ...
                                            <span className={"month" + (this.state.monthVisible ? '_none' : '') }>
                                                ...
                                                <input className={"input-calc-half"+(this.state.validMonth?"":"-error")} type="number" value={this.state.cashboxCloseDoc} onChange={this.onChangeMonth}></input>
                                            </span>
